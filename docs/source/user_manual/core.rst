...
* **instance** -- Instance instance in the `Instance <instance.html>`_ package. :)
...
* **limitation** -- An instance of the `Limitation <core_modules/comparator.module.html>`_ module.
